...
<body>
	...
	<a href="<%=request.getContextPath()%>/Manager/add-batch.jsp">Click here to here add new batch</a>
	<table border="1">
		<tr>
			<th>BatchId</th>
			<th>Start Date</th>
		...
		<c:forEach var="batch" items="${batches }">
			...
			<td>
			<a href="<%=request.getContextPath()%>/ManagerServlet/deletebatch?batchId=${batch.batchId}">delete</a>
			</td>
			<td>
			<a href="<%=request.getContextPath()%>/ManagerServlet/editbatch?batchId=${batch.batchId}">update</a>
			</td>
			</tr>
		</c:forEach>
